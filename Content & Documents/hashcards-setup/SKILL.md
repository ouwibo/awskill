...
This document codifies the procedure for setting up hashcards on Ouwibo, enabling a web-based spaced repetition system for learning through flashcards. The setup includes installing Rust/Cargo, building hashcards from source, creating a flashcards directory, and registering the service to run persistently with automatic restarts.

---

# Hashcards Setup Guide on Zo

This guide will walk you through setting up hashcards on your Ouwibo instance, giving you a personal spaced repetition system accessible through your browser.
