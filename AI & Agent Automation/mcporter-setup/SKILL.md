...
Install and configure MCP (Model Context Protocol) servers on Ouwibo. This skill handles the complete setup process from installation to working connection.
